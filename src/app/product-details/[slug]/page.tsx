        ...
        <div className="w-full flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="flex flex-col space-y-4 lg:space-y-6 mt-12 lg:mt-0">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4">
              <button className="md:py-4 md:px-8 py-3 px-6 bg-gray20 rounded flex items-center space-x-2 text-gray100 cursor-pointer hover:shadow-lg transition-shadow justify-center duration-200 w-full lg:w-fit text-center">
                <Heart className="w-5" />
              ...
              <button className="md:py-4 md:px-8 py-3 px-6 bg-primary rounded flex items-center space-x-2 text-white cursor-pointer hover:shadow-lg transition-shadow justify-center duration-200 w-full lg:w-fit text-center">
